      ...
      <tbody>
        ...
        ?>
            ...
            <tr>
              ...
              <td><?= $baris['katnama']; ?></td>
              <td>
                <a href="<?= site_url('hapus-kategori/') . $baris['katid']; ?>" class="fas fa-trash" style="color: #0033ff;"></a>
                <a href="<?= site_url('edit-kategori/') . $baris['katid']; ?>" class="fas fa-edit" style="color: #0033ff;"></a>
              </td>
